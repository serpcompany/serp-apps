<template>
  <AppPageContainer :title="`Newsletter Subscribers (${subscribers?.length || 0})`">
      ...
      <table class="w-full table-auto text-left text-sm">
        ...
        <tbody>
          ...
          >
            ...
            <td class="p-2">
              <UTooltip :text="formatDate(subscriber.createdAt)" :delay-duration="0">
                <div>
...
const { data: subscribers } = await useFetch('/api/super-admin/newsletter-subscribers');
