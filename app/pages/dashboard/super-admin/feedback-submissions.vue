<template>
  <AppPageContainer title="Feedback">
      ...
      <table class="w-full table-auto text-left text-sm">
        ...
        <tbody>
          ...
          >
            ...
            <td class="p-2">
              <UTooltip :text="formatDate(feedbackItem.createdAt)" :delay-duration="0">
                <div>
      ...
      <template #body>
        ...
        <div class="mb-4 rounded-lg bg-neutral-50 p-4 dark:bg-neutral-800">
          <div class="grid grid-cols-2 gap-3 text-xs">
            ...
            <div v-if="selectedFeedback?.meta?.colorScheme">
              ...
              <span class="ml-2 text-neutral-500 capitalize dark:text-neutral-400">{{
        ...
        <UForm :state="replyFormState" @submit="handleReply">
          ...
          <div class="mt-4 flex justify-end gap-2">
            <UButton variant="ghost" color="neutral" @click="replyModal = false"> Cancel </UButton>
            <UButton type="submit" :loading="isSubmitting"> Send Reply </UButton>
          </div>
        </UForm>
      </template>
    </UModal>
    ...
    >
      <template #body>
        <div class="flex justify-end gap-2">
          ...
          />
          <UButton color="error" :loading="isDeleting" label="Delete" @click="handleDelete" />
        </div>
      </template>
    </UModal>
  </AppPageContainer>
...
const { data: feedback, refresh } = await useFetch<Feedback[]>('/api/super-admin/feedback');
